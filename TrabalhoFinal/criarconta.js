...
formulario.addEventListener('submit', async function (evento) {
  ...
  // Salva os dados do perfil na tabela usuarios.
  // A tabela precisa ter as colunas id (uuid) e email (text).
...
/*
  ...
  // Mostra um erro caso não tenha sido possível salvar o perfil.
  if (respostaPerfil.error) {
    mensagemGeral.textContent = respostaPerfil.error.message;
  } else {
    // Mostra sucesso e apaga os campos quando tudo foi salvo.
    mensagemGeral.classList.add('sucesso');
    mensagemGeral.textContent = 'Conta criada com sucesso!';
    formulario.reset();
  }
*/
/*
...
document.getElementById('botaoCriarConta').addEventListener('click', function salvarUsuario(){});
